package Cap14;
// Metodos String, equals, equalIgnoreCase, compareTo e regionMatches
public class StringCompare {
    public static void main(String[] args) {
        ...
        if (s1 == "hello") { // falso porque s1 e um objeto e "hello" e uma string literal
            System.out.println("s1 is the same object as \"hello\"");
        } else {
            System.out.println("s1 is not the same object as \"hello\"");
        }

        //testa a igualdade (ignora maiusculas e minusculas)
        ...
        //testa regionMatches (case sensitive)
        ...
        //testa regionMatches (ignore case)
